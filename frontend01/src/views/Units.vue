...
export default {
  ...
  methods: {
    ...
    fetchUnits() {
      axios.get("https://k1dobevofh.ap.loclx.io/user_units", {
    ...
    fetchBalance(unit) {
      axios.get(`https://k1dobevofh.ap.loclx.io/unit/${unit.id}/balances`, {
        headers: { Authorization: `Bearer ${localStorage.getItem("access_token")}` }
      })
        .then((response) => {
    ...
    showDelinquencies(unit) {
      ...
      Promise.all([
        axios.get(`https://k1dobevofh.ap.loclx.io/unit/${unit.id}/delinquencies`, {
          headers: { Authorization: `Bearer ${localStorage.getItem("access_token")}` }
        }),
        axios.get(`https://k1dobevofh.ap.loclx.io/unit/${unit.id}/transactions`, {
          headers: { Authorization: `Bearer ${localStorage.getItem("access_token")}` }
        })
      ])
