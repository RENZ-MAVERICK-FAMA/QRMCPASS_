  ...
  <template>
    ...
    <div class="container-fluid">
      ...
      <div v-if="error" id="alert" class="alert alert-warning " role="alert">
    ...
    <div class="container">
      <div class="container-sm">
        <h2 class="display-1">Motorela Payment</h2>
      <br>
        <div>
      ...
      <div class="form-group">
        ...
        <br>
        <label class="display-3" for="branch">Branch</label>
        <br>
        <input v-model="selectedBranch" class="form-control" name="branch" id="branch" value="Toll-Booth" placeholder="Toll-Booth" required readonly>
      </div>
      <br>
      <div class="form-group">
      ...
      <select v-model="selectedDevice" class="form-select form-select-sm">
          ...
          <button @click="generateAndDownloadPDF" class="btn btn-success" style=" margin-top: 40px; margin-left: 90px;">Generate PDF Report</button>
    ...
    <thead>
      <tr>
        <th><strong class="display-1">Motorela</strong></th>
      </tr>
    </thead>
    <tbody>
      <tr>
...
unit.transactions.slice(startIndex1).forEach((transaction, index) => {
  ...
  generateAndDownloadPDF() {
    ...
    let text3 = 'Motorela Units Report';
...
,
  ...
  localStorage.setItem('detectedCodesMotorela', JSON.stringify(this.detectedCodes));
        ...
        axios.get('http://127.0.0.1:9000/admin/delinquencies/motorela/daily', {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('access_token')}`,
          },
        })
