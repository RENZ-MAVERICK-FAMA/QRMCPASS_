...
export default {
  ...
  methods: {
    ...
    fetchCoins() {
      axios
        .get("https://y2mifxhqo2.loclx.io/inserted_coins", {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("access_token")}`,
          },
        })
    ...
    topup() {
      ...
      axios
        ...
        .then((response) => {
          ...
          axios
            .post("https://y2mifxhqo2.loclx.io/kiosktopup", data, {
              headers: {
                Authorization: `Bearer ${localStorage.getItem("access_token")}`,
                "Content-Type": "application/json",
    ...
    async onDetect(detectedQRCodes) {
      ...
      const paymentResponse = await axios.get(
        `https://y2mifxhqo2.loclx.io/payment-details?unit_info=${detectedWrCode}`
      );
