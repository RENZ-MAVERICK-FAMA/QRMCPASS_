 <template>
  ...
  export default {
    ...
    methods: {
      ...
      axios.post('https://y2mifxhqo2.loclx.io/addAdmin', formData)
        .then(response => {
      this.username = '';
      this.firstName = '';
      this.lastName = '';
      ...
      async fetchadmins() {
        try {
          const response = await axios.get('https://y2mifxhqo2.loclx.io/admins');
  ...
  axios.put(`https://y2mifxhqo2.loclx.io/updateAdmin/${id}`, updatedData)
    .then(response => {
