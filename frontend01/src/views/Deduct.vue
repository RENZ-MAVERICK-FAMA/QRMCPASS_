<template>
  ...
  <div class="grid grid-rows-1 grid-cols-2 gap-1">
    <h2 class="text-[18px] font-bold">Delinquencies</h2>
    <!-- Optional button for show more/less functionality -->
    <!-- <button
      v-if="delinquencies.length > 5"
      @click="toggleShowMore"
  ...
  <div class="scrollable-list mt-2">
    ...
    <p v-if="visibleDelinquencies.length === 0" class="text-gray-500">
      No delinquencies for the selected unit.
    </p>
  </div>

  <!-- Payments Section -->
  <div class="grid grid-rows-1 grid-cols-2 gap-1 mt-6">
  ...
  <div class="scrollable-list mt-2">
    ...
    <p v-if="visibleTransactions.length === 0" class="text-gray-500">
