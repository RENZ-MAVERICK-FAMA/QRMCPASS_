    ...
    export default {
      ...
      const isMounted = ref(false);
        ...
        const fetchUnitsData = async () => {
          try {
            const response = await axios.get('https://zfhlpd2pxk.loclx.io/paid', {
              headers: {
        ...
        const fetchBalances = async (unitId) => {
          try {
            const response = await axios.get(`https://zfhlpd2pxk.loclx.io/unit/${unitId}/balances`, {
              headers: {
                Authorization: `Bearer ${localStorage.getItem('access_token')}`
              }
            });
        ...
        const fetchDelinquencies = async (unitId) => {
          try {
            const response = await axios.get(`https://zfhlpd2pxk.loclx.io/unit/${unitId}/delinquencies`, {
              headers: {
                Authorization: `Bearer ${localStorage.getItem('access_token')}`
              }
            });
        ...
        const fetchTransactions = async (unitId) => {
          try {
            const response = await axios.get(`https://zfhlpd2pxk.loclx.io/unit/${unitId}/transactions`, {
              headers: {
                Authorization: `Bearer ${localStorage.getItem('access_token')}`
              }
            });
        ...
        const fetchUnitDetails = async () => {
          try {
            const response = await axios.get('https://zfhlpd2pxk.loclx.io/unitdetails', {
              headers: {
                Authorization: `Bearer ${localStorage.getItem('access_token')}`
              }
            });
