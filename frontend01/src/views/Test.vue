  ...
  <div class=" h-auto p-5 grid place-content-center mt-5 md:mt-10" >
      <div class="bg-white shadow rounded-[20px] p-10 grid grid-rows-[100px,1fr] grid-cols-1 md:grid-rows-1 md:grid-cols-2 md:w-[800px]" >
        <div class="mt-4" >
          ...
          <p class="hidden md:block font-light" >Pinaagi sa QRMCPASS, makapapalong ka sa imong mga proseso sa pagdumala sa imong rela o multicab, makailhan sa mga delikwensiya, ug makasiguro nga ang mga pamatasan sa kalidad gipatuman.</p><br/>
